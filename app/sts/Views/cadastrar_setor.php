...
<div class="title">
    ...
    <h1 class="home">Cadastro Setores</h1>
    ...
    <input class="cadi" type="text" name="nome" placeholder="Digite o Nome do Lider" required >

    <label for="" class="cadu">Setor</label>
    <input class="cadi" type="text" name="setor" placeholder="Digite o Nome do Setor" required>
